...
const productsData: Record<string, Array<{
  ...
  'steel-iron': [
    ...
    { name: 'Steel Rebar 16mm', nameAr: 'حديد تسليح 16 مم', sku: 'STL-002', barcode: '5901234560011', price: 28, costPrice: 22, unit: 'meter', unitAr: 'متر', stock: 1500, image: 'https://images.unsplash.com/photo-1530982011887-3cc11cc85693?w=400&q=80' },
    { name: 'Steel Mesh 2x3m', nameAr: 'شبك حديد 2×3 م', sku: 'STL-003', barcode: '5901234560012', price: 120, costPrice: 95, unit: 'sheet', unitAr: 'لوح', stock: 200, image: 'https://images.unsplash.com/photo-1605152276897-4f618f831968?w=400&q=80' },
    { name: 'Iron Angle Bar 40x40mm', nameAr: 'زاوية حديد 40×40 مم', sku: 'STL-004', barcode: '5901234560013', price: 35, costPrice: 28, unit: 'meter', unitAr: 'متر', stock: 400, image: 'https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=400&q=80' },
    { name: 'Steel Pipe 2 inch', nameAr: 'أنبوب حديد 2 بوصة', sku: 'STL-005', barcode: '5901234560014', price: 55, costPrice: 42, unit: 'meter', unitAr: 'متر', stock: 300, image: 'https://images.unsplash.com/photo-1533106497176-45ae19e68ba2?w=400&q=80' },
  ],
  'wood-doors': [
  ...
  'paints-colors': [
    { name: 'Interior Wall Paint White 18L', nameAr: 'دهان جدران داخلي أبيض 18 لتر', sku: 'PNT-001', barcode: '5901234560030', price: 220, costPrice: 170, unit: 'bucket', unitAr: 'سطل', stock: 150, featured: true, image: 'https://images.unsplash.com/photo-1562259929-b4e1fd3aef09?w=400&q=80' },
  ...
  'electrical-lighting': [
    { name: 'LED Panel Light 60x60', nameAr: 'لوحة إضاءة LED 60×60', sku: 'ELC-001', barcode: '5901234560040', price: 85, costPrice: 60, unit: 'piece', unitAr: 'قطعة', stock: 200, featured: true, image: 'https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=400&q=80' },
  ...
  'tools-equipment': [
    { name: 'Power Drill 750W', nameAr: 'مثقاب كهربائي 750 واط', sku: 'TOL-001', barcode: '5901234560070', price: 280, costPrice: 210, unit: 'piece', unitAr: 'قطعة', stock: 40, featured: true, image: 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=400&q=80' },
  ...
  'sand-gravel': [
    ...
    { name: 'Washed Sand (ton)', nameAr: 'رمل مغسول (طن)', sku: 'SND-002', barcode: '5901234560081', price: 200, costPrice: 150, unit: 'ton', unitAr: 'طن', stock: 80, image: 'https://images.unsplash.com/photo-1558449028-b53a39d100fc?w=400&q=80' },
    { name: 'Gravel 20mm (ton)', nameAr: 'حصى 20 مم (طن)', sku: 'SND-003', barcode: '5901234560082', price: 160, costPrice: 120, unit: 'ton', unitAr: 'طن', stock: 120, image: 'https://images.unsplash.com/photo-1533106497176-45ae19e68ba2?w=400&q=80' },
    { name: 'Crushed Stone (ton)', nameAr: 'حجر مكسر (طن)', sku: 'SND-004', barcode: '5901234560083', price: 140, costPrice: 100, unit: 'ton', unitAr: 'طن', stock: 150, image: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=400&q=80' },
    { name: 'Decorative Pebbles 25kg', nameAr: 'حصى ديكور 25 كغم', sku: 'SND-005', barcode: '5901234560084', price: 45, costPrice: 30, unit: 'bag', unitAr: 'كيس', stock: 200, image: 'https://images.unsplash.com/photo-1544736779-08492534e887?w=400&q=80' },
  ],
  'insulation': [
  ...
  'glass-mirrors': [
    ...
    { name: 'Frosted Glass 6mm', nameAr: 'زجاج مصنفر 6 مم', sku: 'GLS-005', barcode: '5901234560104', price: 90, costPrice: 65, unit: 'sqm', unitAr: 'متر مربع', stock: 70, image: 'https://images.unsplash.com/photo-1495774856032-8b90bbb32b32?w=400&q=80' },
  ],
  'safety-equipment': [
    { name: 'Safety Helmet', nameAr: 'خوذة سلامة', sku: 'SAF-001', barcode: '5901234560110', price: 35, costPrice: 22, unit: 'piece', unitAr: 'قطعة', stock: 200, featured: true, image: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=400&q=80' },
    { name: 'Safety Vest Reflective', nameAr: 'سترة سلامة عاكسة', sku: 'SAF-002', barcode: '5901234560111', price: 25, costPrice: 15, unit: 'piece', unitAr: 'قطعة', stock: 300, image: 'https://images.unsplash.com/photo-1578874691223-64558a3ca096?w=400&q=80' },
    { name: 'Work Gloves Heavy Duty', nameAr: 'قفازات عمل شديدة التحمل', sku: 'SAF-003', barcode: '5901234560112', price: 18, costPrice: 10, unit: 'pair', unitAr: 'زوج', stock: 500, image: 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=400&q=80' },
    { name: 'Safety Goggles', nameAr: 'نظارات سلامة', sku: 'SAF-004', barcode: '5901234560113', price: 22, costPrice: 12, unit: 'piece', unitAr: 'قطعة', stock: 250, image: 'https://images.unsplash.com/photo-1530991472021-ce0e43475f6e?w=400&q=80' },
    { name: 'Safety Boots Size 42', nameAr: 'حذاء سلامة مقاس 42', sku: 'SAF-005', barcode: '5901234560114', price: 180, costPrice: 130, unit: 'pair', unitAr: 'زوج', stock: 60, image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80' },
  ],
};
