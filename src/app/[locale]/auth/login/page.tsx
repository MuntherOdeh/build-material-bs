        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-4 leading-tight">
              {isRTL
                ? 'ابدأ رحلة البناء معنا'
                : 'Start Your Building Journey With Us'}
            </h2>
            <p className="text-lg text-white/80 max-w-md">
              {isRTL
                ? 'تسوق من أكبر تشكيلة مواد بناء بأفضل الأسعار وخدمة توصيل سريعة'
                : 'Shop from the largest collection of building materials at the best prices with fast delivery'}
            </p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full ${isRTL ? 'pr-12 pl-4' : 'pl-12 pr-4'} py-3.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all text-sm`}
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full ${isRTL ? 'pr-12 pl-12' : 'pl-12 pr-12'} py-3.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all text-sm`}
                  required
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-orange-500 text-white rounded-xl font-bold text-base hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/25 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
