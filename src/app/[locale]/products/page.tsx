...
const products: Product[] = [
  { id: '1', name: 'Portland Cement 50kg', nameAr: 'إسمنت بورتلاندي 50 كيلو', price: 28, salePrice: 24, image: unsplashImages[0], category: 'Cement', categoryAr: 'إسمنت وخرسانة', unit: 'Bag', unitAr: 'كيس', stock: 500, sku: 'CEM-001', featured: true },
  { id: '2', name: 'White Cement 25kg', nameAr: 'إسمنت أبيض 25 كيلو', price: 35, image: unsplashImages[0], category: 'Cement', categoryAr: 'إسمنت وخرسانة', unit: 'Bag', unitAr: 'كيس', stock: 200, sku: 'CEM-002' },
  { id: '3', name: 'Steel Rebar 12mm', nameAr: 'حديد تسليح 12 ملم', price: 45, salePrice: 40, image: unsplashImages[1], category: 'Steel', categoryAr: 'حديد وصلب', unit: 'Meter', unitAr: 'متر', stock: 1000, sku: 'STL-001', featured: true },
  { id: '4', name: 'Steel Rebar 16mm', nameAr: 'حديد تسليح 16 ملم', price: 62, image: unsplashImages[1], category: 'Steel', categoryAr: 'حديد وصلب', unit: 'Meter', unitAr: 'متر', stock: 800, sku: 'STL-002' },
  { id: '5', name: 'Pine Wood Plank 2x4', nameAr: 'خشب صنوبر 2×4', price: 18, image: unsplashImages[2], category: 'Wood', categoryAr: 'خشب وأبواب', unit: 'Piece', unitAr: 'قطعة', stock: 350, sku: 'WOD-001' },
  { id: '6', name: 'MDF Board 18mm', nameAr: 'لوح MDF 18 ملم', price: 85, salePrice: 72, image: unsplashImages[2], category: 'Wood', categoryAr: 'خشب وأبواب', unit: 'Piece', unitAr: 'قطعة', stock: 120, sku: 'WOD-002', featured: true },
  { id: '7', name: 'Interior Wall Paint 18L', nameAr: 'دهان حائط داخلي 18 لتر', price: 120, image: unsplashImages[3], category: 'Paint', categoryAr: 'دهانات وألوان', unit: 'Piece', unitAr: 'قطعة', stock: 80, sku: 'PNT-001' },
  { id: '8', name: 'Exterior Paint 18L', nameAr: 'دهان خارجي 18 لتر', price: 155, salePrice: 135, image: unsplashImages[3], category: 'Paint', categoryAr: 'دهانات وألوان', unit: 'Piece', unitAr: 'قطعة', stock: 60, sku: 'PNT-002' },
  { id: '9', name: 'Electrical Cable 2.5mm 100m', nameAr: 'سلك كهربائي 2.5 ملم 100 متر', price: 95, image: unsplashImages[4], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'Roll', unitAr: 'رول', stock: 150, sku: 'ELC-001' },
  { id: '10', name: 'LED Panel Light 60x60', nameAr: 'لوحة إضاءة LED 60×60', price: 45, salePrice: 38, image: unsplashImages[4], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'Piece', unitAr: 'قطعة', stock: 200, sku: 'ELC-002', featured: true },
  { id: '11', name: 'PVC Pipe 4 inch', nameAr: 'أنبوب PVC 4 إنش', price: 22, image: unsplashImages[5], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'Meter', unitAr: 'متر', stock: 400, sku: 'PLB-001' },
  { id: '12', name: 'Water Heater 50L', nameAr: 'سخان مياه 50 لتر', price: 320, salePrice: 280, image: unsplashImages[5], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'Piece', unitAr: 'قطعة', stock: 25, sku: 'PLB-002' },
  { id: '13', name: 'Ceramic Floor Tile 60x60', nameAr: 'بلاط سيراميك أرضي 60×60', price: 38, image: unsplashImages[6], category: 'Tiles', categoryAr: 'بلاط وسيراميك', unit: 'Sq. Meter', unitAr: 'متر مربع', stock: 2000, sku: 'TIL-001', featured: true },
  { id: '14', name: 'Porcelain Wall Tile 30x60', nameAr: 'بورسلين حائط 30×60', price: 55, salePrice: 48, image: unsplashImages[6], category: 'Tiles', categoryAr: 'بلاط وسيراميك', unit: 'Sq. Meter', unitAr: 'متر مربع', stock: 1500, sku: 'TIL-002' },
  { id: '15', name: 'Power Drill 750W', nameAr: 'شنيور كهربائي 750 واط', price: 185, image: unsplashImages[7], category: 'Tools', categoryAr: 'أدوات ومعدات', unit: 'Piece', unitAr: 'قطعة', stock: 45, sku: 'TOL-001' },
  { id: '16', name: 'Angle Grinder 125mm', nameAr: 'صاروخ جلخ 125 ملم', price: 140, salePrice: 115, image: unsplashImages[7], category: 'Tools', categoryAr: 'أدوات ومعدات', unit: 'Piece', unitAr: 'قطعة', stock: 30, sku: 'TOL-002', featured: true },
  { id: '17', name: 'Building Sand (Ton)', nameAr: 'رمل بناء (طن)', price: 75, image: unsplashImages[0], category: 'Sand', categoryAr: 'رمل وحصى', unit: 'Ton', unitAr: 'طن', stock: 100, sku: 'SND-001' },
  { id: '18', name: 'Gravel Mix 20mm (Ton)', nameAr: 'حصى مخلوط 20 ملم (طن)', price: 65, image: unsplashImages[0], category: 'Sand', categoryAr: 'رمل وحصى', unit: 'Ton', unitAr: 'طن', stock: 80, sku: 'SND-002' },
  { id: '19', name: 'Thermal Insulation Roll 50mm', nameAr: 'لفة عزل حراري 50 ملم', price: 42, salePrice: 36, image: unsplashImages[1], category: 'Insulation', categoryAr: 'عزل وعوازل', unit: 'Roll', unitAr: 'رول', stock: 90, sku: 'INS-001' },
  { id: '20', name: 'Waterproof Membrane 1m', nameAr: 'عازل مائي 1 متر', price: 28, image: unsplashImages[1], category: 'Insulation', categoryAr: 'عزل وعوازل', unit: 'Sq. Meter', unitAr: 'متر مربع', stock: 500, sku: 'INS-002' },
  { id: '21', name: 'Clear Glass 6mm', nameAr: 'زجاج شفاف 6 ملم', price: 55, image: unsplashImages[2], category: 'Glass', categoryAr: 'زجاج ومرايا', unit: 'Sq. Meter', unitAr: 'متر مربع', stock: 300, sku: 'GLS-001' },
  { id: '22', name: 'Double Glazed Window', nameAr: 'نافذة زجاج مزدوج', price: 280, salePrice: 245, image: unsplashImages[2], category: 'Glass', categoryAr: 'زجاج ومرايا', unit: 'Piece', unitAr: 'قطعة', stock: 40, sku: 'GLS-002', featured: true },
  { id: '23', name: 'Safety Helmet', nameAr: 'خوذة سلامة', price: 25, image: unsplashImages[3], category: 'Safety', categoryAr: 'معدات سلامة', unit: 'Piece', unitAr: 'قطعة', stock: 200, sku: 'SAF-001' },
  { id: '24', name: 'Safety Vest High Vis', nameAr: 'سترة سلامة عاكسة', price: 18, image: unsplashImages[3], category: 'Safety', categoryAr: 'معدات سلامة', unit: 'Piece', unitAr: 'قطعة', stock: 300, sku: 'SAF-002' },
  { id: '25', name: 'Ready Mix Concrete', nameAr: 'خرسانة جاهزة', price: 320, image: unsplashImages[4], category: 'Cement', categoryAr: 'إسمنت وخرسانة', unit: 'Ton', unitAr: 'طن', stock: 50, sku: 'CEM-003' },
  { id: '26', name: 'Steel Wire Mesh', nameAr: 'شبك حديد ملحوم', price: 95, salePrice: 82, image: unsplashImages[5], category: 'Steel', categoryAr: 'حديد وصلب', unit: 'Piece', unitAr: 'قطعة', stock: 150, sku: 'STL-003' },
];
