...
const products: Product[] = [
  // ── Cement & Concrete ──
  { id: 'CEM001', name: 'Portland Cement 50kg', nameAr: 'إسمنت بورتلاندي 50كغ', price: 35, image: CATEGORY_IMAGES['Cement & Concrete'], category: 'Cement & Concrete', categoryAr: 'إسمنت وخرسانة', unit: 'bag', unitAr: 'كيس', stock: 500, sku: 'CEM-PORT-50', barcode: '7290001000011' },
  { id: 'CEM002', name: 'White Cement 25kg', nameAr: 'إسمنت أبيض 25كغ', price: 45, image: CATEGORY_IMAGES['Cement & Concrete'], category: 'Cement & Concrete', categoryAr: 'إسمنت وخرسانة', unit: 'bag', unitAr: 'كيس', stock: 200, sku: 'CEM-WHT-25', barcode: '7290001000028' },
  { id: 'CEM003', name: 'Ready Mix Concrete', nameAr: 'خرسانة جاهزة', price: 280, image: CATEGORY_IMAGES['Cement & Concrete'], category: 'Cement & Concrete', categoryAr: 'إسمنت وخرسانة', unit: 'ton', unitAr: 'طن', stock: 50, sku: 'CEM-RDY-MX', barcode: '7290001000035' },
  { id: 'CEM004', name: 'Cement Blocks', nameAr: 'بلوك إسمنتي', price: 4.5, image: CATEGORY_IMAGES['Cement & Concrete'], category: 'Cement & Concrete', categoryAr: 'إسمنت وخرسانة', unit: 'piece', unitAr: 'حبة', stock: 2000, sku: 'CEM-BLK-01', barcode: '7290001000042' },
  { id: 'CEM005', name: 'Mortar Mix', nameAr: 'خلطة مونة', price: 22, image: CATEGORY_IMAGES['Cement & Concrete'], category: 'Cement & Concrete', categoryAr: 'إسمنت وخرسانة', unit: 'bag', unitAr: 'كيس', stock: 300, sku: 'CEM-MRT-01', barcode: '7290001000059' },

  // ── Steel & Iron ──
  { id: 'STL001', name: 'Steel Rebar 12mm', nameAr: 'حديد تسليح 12مم', price: 18, image: CATEGORY_IMAGES['Steel & Iron'], category: 'Steel & Iron', categoryAr: 'حديد وصلب', unit: 'meter', unitAr: 'متر', stock: 1000, sku: 'STL-RBR-12', barcode: '7290002000018' },
  { id: 'STL002', name: 'Steel Rebar 16mm', nameAr: 'حديد تسليح 16مم', price: 32, image: CATEGORY_IMAGES['Steel & Iron'], category: 'Steel & Iron', categoryAr: 'حديد وصلب', unit: 'meter', unitAr: 'متر', stock: 800, sku: 'STL-RBR-16', barcode: '7290002000025' },
  { id: 'STL003', name: 'Steel Mesh', nameAr: 'شبك حديد', price: 85, image: CATEGORY_IMAGES['Steel & Iron'], category: 'Steel & Iron', categoryAr: 'حديد وصلب', unit: 'sqm', unitAr: 'م²', stock: 150, sku: 'STL-MSH-01', barcode: '7290002000032' },
  { id: 'STL004', name: 'Binding Wire', nameAr: 'سلك ربط', price: 12, image: CATEGORY_IMAGES['Steel & Iron'], category: 'Steel & Iron', categoryAr: 'حديد وصلب', unit: 'kg', unitAr: 'كغ', stock: 500, sku: 'STL-BWR-01', barcode: '7290002000049' },
  { id: 'STL005', name: 'Steel Angles', nameAr: 'زوايا حديد', price: 45, image: CATEGORY_IMAGES['Steel & Iron'], category: 'Steel & Iron', categoryAr: 'حديد وصلب', unit: 'meter', unitAr: 'متر', stock: 300, sku: 'STL-ANG-01', barcode: '7290002000056' },

  // ── Wood & Doors ──
  { id: 'WOD001', name: 'Pine Wood Plank', nameAr: 'خشب صنوبر', price: 65, image: CATEGORY_IMAGES['Wood & Doors'], category: 'Wood & Doors', categoryAr: 'خشب وأبواب', unit: 'meter', unitAr: 'متر', stock: 400, sku: 'WOD-PIN-01', barcode: '7290003000015' },
  { id: 'WOD002', name: 'MDF Board', nameAr: 'لوح MDF', price: 120, image: CATEGORY_IMAGES['Wood & Doors'], category: 'Wood & Doors', categoryAr: 'خشب وأبواب', unit: 'piece', unitAr: 'قطعة', stock: 100, sku: 'WOD-MDF-01', barcode: '7290003000022' },
  { id: 'WOD003', name: 'Interior Door', nameAr: 'باب داخلي', price: 450, image: CATEGORY_IMAGES['Wood & Doors'], category: 'Wood & Doors', categoryAr: 'خشب وأبواب', unit: 'piece', unitAr: 'قطعة', stock: 30, sku: 'WOD-DOR-INT', barcode: '7290003000039' },
  { id: 'WOD004', name: 'Plywood Sheet', nameAr: 'خشب أبلكاش', price: 95, image: CATEGORY_IMAGES['Wood & Doors'], category: 'Wood & Doors', categoryAr: 'خشب وأبواب', unit: 'piece', unitAr: 'قطعة', stock: 80, sku: 'WOD-PLY-01', barcode: '7290003000046' },
  { id: 'WOD005', name: 'Wood Trim', nameAr: 'قص خشب', price: 15, image: CATEGORY_IMAGES['Wood & Doors'], category: 'Wood & Doors', categoryAr: 'خشب وأبواب', unit: 'meter', unitAr: 'متر', stock: 600, sku: 'WOD-TRM-01', barcode: '7290003000053' },

  // ── Paints & Colors ──
  { id: 'PNT001', name: 'Interior Paint 18L', nameAr: 'دهان داخلي 18 لتر', price: 180, image: CATEGORY_IMAGES['Paints & Colors'], category: 'Paints & Colors', categoryAr: 'دهانات وألوان', unit: 'bucket', unitAr: 'سطل', stock: 60, sku: 'PNT-INT-18', barcode: '7290004000012' },
  { id: 'PNT002', name: 'Exterior Paint 18L', nameAr: 'دهان خارجي 18 لتر', price: 220, image: CATEGORY_IMAGES['Paints & Colors'], category: 'Paints & Colors', categoryAr: 'دهانات وألوان', unit: 'bucket', unitAr: 'سطل', stock: 45, sku: 'PNT-EXT-18', barcode: '7290004000029' },
  { id: 'PNT003', name: 'Wood Varnish', nameAr: 'ورنيش خشب', price: 85, image: CATEGORY_IMAGES['Paints & Colors'], category: 'Paints & Colors', categoryAr: 'دهانات وألوان', unit: 'liter', unitAr: 'لتر', stock: 100, sku: 'PNT-VRN-01', barcode: '7290004000036' },
  { id: 'PNT004', name: 'Primer 10L', nameAr: 'أساس دهان 10 لتر', price: 95, image: CATEGORY_IMAGES['Paints & Colors'], category: 'Paints & Colors', categoryAr: 'دهانات وألوان', unit: 'bucket', unitAr: 'سطل', stock: 70, sku: 'PNT-PRM-10', barcode: '7290004000043' },
  { id: 'PNT005', name: 'Spray Paint', nameAr: 'دهان بخاخ', price: 18, image: CATEGORY_IMAGES['Paints & Colors'], category: 'Paints & Colors', categoryAr: 'دهانات وألوان', unit: 'piece', unitAr: 'حبة', stock: 200, sku: 'PNT-SPR-01', barcode: '7290004000050' },

  // ── Electrical ──
  { id: 'ELC001', name: 'LED Panel 60x60', nameAr: 'لوحة LED 60x60', price: 75, image: CATEGORY_IMAGES['Electrical'], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'piece', unitAr: 'قطعة', stock: 120, sku: 'ELC-LED-60', barcode: '7290005000019' },
  { id: 'ELC002', name: 'Electrical Wire 2.5mm', nameAr: 'سلك كهربائي 2.5مم', price: 2.5, image: CATEGORY_IMAGES['Electrical'], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'meter', unitAr: 'متر', stock: 5000, sku: 'ELC-WIR-25', barcode: '7290005000026' },
  { id: 'ELC003', name: 'Switch Socket', nameAr: 'مفتاح ومقبس', price: 15, image: CATEGORY_IMAGES['Electrical'], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'piece', unitAr: 'قطعة', stock: 300, sku: 'ELC-SWT-01', barcode: '7290005000033' },
  { id: 'ELC004', name: 'Circuit Breaker', nameAr: 'قاطع كهربائي', price: 35, image: CATEGORY_IMAGES['Electrical'], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'piece', unitAr: 'قطعة', stock: 150, sku: 'ELC-CBR-01', barcode: '7290005000040' },
  { id: 'ELC005', name: 'LED Bulb 12W', nameAr: 'لمبة LED 12 واط', price: 12, image: CATEGORY_IMAGES['Electrical'], category: 'Electrical', categoryAr: 'كهرباء وإنارة', unit: 'piece', unitAr: 'قطعة', stock: 500, sku: 'ELC-BLB-12', barcode: '7290005000057' },

  // ── Plumbing ──
  { id: 'PLM001', name: 'PVC Pipe 4inch', nameAr: 'أنبوب PVC 4 إنش', price: 28, image: CATEGORY_IMAGES['Plumbing'], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'meter', unitAr: 'متر', stock: 400, sku: 'PLM-PVC-04', barcode: '7290006000016' },
  { id: 'PLM002', name: 'Water Heater 50L', nameAr: 'سخان مياه 50 لتر', price: 650, image: CATEGORY_IMAGES['Plumbing'], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'piece', unitAr: 'قطعة', stock: 15, sku: 'PLM-WHT-50', barcode: '7290006000023' },
  { id: 'PLM003', name: 'Toilet Set', nameAr: 'طقم حمام', price: 850, image: CATEGORY_IMAGES['Plumbing'], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'piece', unitAr: 'قطعة', stock: 10, sku: 'PLM-TLT-01', barcode: '7290006000030' },
  { id: 'PLM004', name: 'Faucet', nameAr: 'حنفية', price: 120, image: CATEGORY_IMAGES['Plumbing'], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'piece', unitAr: 'قطعة', stock: 60, sku: 'PLM-FCT-01', barcode: '7290006000047' },
  { id: 'PLM005', name: 'Water Tank 1000L', nameAr: 'خزان مياه 1000 لتر', price: 450, image: CATEGORY_IMAGES['Plumbing'], category: 'Plumbing', categoryAr: 'سباكة وصحية', unit: 'piece', unitAr: 'قطعة', stock: 8, sku: 'PLM-TNK-1K', barcode: '7290006000054' },

  // ── Tiles & Ceramics ──
  { id: 'TIL001', name: 'Floor Tile 60x60', nameAr: 'بلاط أرضي 60x60', price: 45, image: CATEGORY_IMAGES['Tiles & Ceramics'], category: 'Tiles & Ceramics', categoryAr: 'بلاط وسيراميك', unit: 'sqm', unitAr: 'م²', stock: 800, sku: 'TIL-FLR-60', barcode: '7290007000013' },
  { id: 'TIL002', name: 'Wall Tile 30x60', nameAr: 'بلاط جداري 30x60', price: 38, image: CATEGORY_IMAGES['Tiles & Ceramics'], category: 'Tiles & Ceramics', categoryAr: 'بلاط وسيراميك', unit: 'sqm', unitAr: 'م²', stock: 600, sku: 'TIL-WLL-30', barcode: '7290007000020' },
  { id: 'TIL003', name: 'Porcelain Tile', nameAr: 'بورسلان', price: 65, image: CATEGORY_IMAGES['Tiles & Ceramics'], category: 'Tiles & Ceramics', categoryAr: 'بلاط وسيراميك', unit: 'sqm', unitAr: 'م²', stock: 400, sku: 'TIL-PRC-01', barcode: '7290007000037' },
  { id: 'TIL004', name: 'Tile Adhesive 25kg', nameAr: 'لاصق بلاط 25كغ', price: 25, image: CATEGORY_IMAGES['Tiles & Ceramics'], category: 'Tiles & Ceramics', categoryAr: 'بلاط وسيراميك', unit: 'bag', unitAr: 'كيس', stock: 250, sku: 'TIL-ADH-25', barcode: '7290007000044' },
  { id: 'TIL005', name: 'Grout', nameAr: 'حشوة بلاط', price: 18, image: CATEGORY_IMAGES['Tiles & Ceramics'], category: 'Tiles & Ceramics', categoryAr: 'بلاط وسيراميك', unit: 'bag', unitAr: 'كيس', stock: 350, sku: 'TIL-GRT-01', barcode: '7290007000051' },
];
